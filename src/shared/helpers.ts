...
import {
  ...
  isWhitelistedEmail as isWhitelistedEmailQuery
} from './queries'
...
import { AccountData, QueryAccountData, PermissionVariables, RequestExtended, IsWhitelistedEmail } from './types'
...
export const isWhitelistedEmail = async (email: string) => {
  return request<IsWhitelistedEmail>(isWhitelistedEmailQuery, {
    email
