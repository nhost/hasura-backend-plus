...
import { generateRandomEmail, generateRandomString, deleteMailHogEmail, mailHogSearch, registerAccount, registerAndLoginAccount, getHeaderFromLatestEmailAndDelete } from '@test/utils'
...
it('should create an account', (done) => {
  request
    .post('/auth/register')
    .send({ email: generateRandomEmail(), password: generateRandomString(), user_data: { name: 'Test name' } })
    .expect(200)
    .end(end(done))
})
